...
- `[x]` **FASE 4: Colaboração e Anexos** — Comentários nos chamados, histórico de auditoria visível e uploads no Supabase Storage.
- `[x]` **FASE 5: Base de Conhecimento e APIs** — Base de artigos técnicos (KB) e API routes para integrações externas.
...
- `[x]` **PHASE 4: Collaboration and Attachments** — Comment section, visible audit logs, and uploads into Supabase Storage.
- `[x]` **PHASE 5: Knowledge Base & APIs** — Security articles database (KB) and API routes prepared for webhooks.
